...
const DEFAULT_BEHIND_GRADIENT = 
  'radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(30,100%,90%,var(--card-opacity)) 4%,hsla(30,60%,80%,calc(var(--card-opacity)*0.75)) 10%,hsla(30,40%,65%,calc(var(--card-opacity)*0.5)) 50%,hsla(30,20%,60%,0) 100%),' +
  'radial-gradient(35% 52% at 55% 20%,#ffb347c4 0%,#ff8c0000 100%),' +
  'radial-gradient(100% 100% at 50% 50%,#ffd580ff 1%,#ff8c0000 76%),' +
  'conic-gradient(from 124deg at 50% 50%,#ff7f50ff 0%,#ffa500ff 40%,#ffa500ff 60%,#ff7f50ff 100%)';


const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg,#ff8c008c 0%,#ffa50066 100%)';
